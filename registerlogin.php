    ...
    <?php
      ...
      if ($_SERVER['REQUEST_METHOD'] === 'POST') {
          if (isset($_POST['register-email'])) {
              ...
              // Presmerovanie pri úspešnom prihlásení
              if ($loginResult === true) {
        ...
        <div class="register-side">
            ...
            <form class="registerlogin-form" action="" method="POST">
                <fieldset>
                    ...
                    <label for="register-password-re">Re-enter Password</label>
                    <input type="password" id="register-password-re" name="register-password-re" required>                 
